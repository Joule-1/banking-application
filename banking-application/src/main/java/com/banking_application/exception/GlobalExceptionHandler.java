...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleCheckedException(ExceptionResponse e){
        return new ResponseEntity<>(new ExceptionResponse(500, "Internal Server Error"), HttpStatus.INTERNAL_SERVER_ERROR);
    }

    @ExceptionHandler(ExceptionResponse.class)
    public ResponseEntity<ExceptionResponse> handleUncheckedException(ExceptionResponse e){
